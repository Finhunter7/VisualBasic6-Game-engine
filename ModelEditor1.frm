...
Sub OpenNew()
    ...
    Dim TImage As New VBCEArrayImage_Class
    
    curFile = FileBrowser1.OpenFile(MainWindow, "Open Image", "*.bmp|*.ico|*.rle|*.wmf")
    TImage.Name = FileBrowser1.GetFileName
    TImage.CreateFromImage LoadPicture(curFile)
    Picture1.Picture = TImage.ToPicture(5, 5)
    Set curRender = TImage
End Sub
Sub Save()
    
    MainWindow.Engine.VBCETextures.Add curRender, curRender.Name
